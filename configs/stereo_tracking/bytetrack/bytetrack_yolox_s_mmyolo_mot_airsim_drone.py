...
data_root = '/home/sijie/Documents/datasets/MOT/AirSim_drone/'
...
model = dict(
    ...
    detector=dict(
        _scope_='mmyolo',
        backbone=dict(type='mmtrack.CSPDarknet'),
    ...
    tracker=dict(
        type='ByteTracker_Disparity',
        obj_score_thrs=dict(high=0.7, low=0.2),
        init_track_thr=0.7,
