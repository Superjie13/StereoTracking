...
class BaseBackbone_Disparity_MMYOLO(BaseModule):
    """Inherit from BaseBackbone backbone used in YOLO series to adapt disparity input.
    ...
    # def forward(self, img: torch.Tensor, disp: torch.Tensor) -> tuple:
