...
from .mot_challenge_dataset import BaseVideoDataset


@DATASETS.register_module()
class MOTKittiDataset(BaseVideoDataset):
    ...
    METAINFO = {
        'CLASSES':
            ('Car'.lower(), 'Van'.lower(), 'Truck'.lower(), 'Pedestrian'.lower(), 'Person'.lower(),
             'Cyclist'.lower(), 'Tram'.lower(), 'Misc'.lower(), 'DontCare'.lower())
    }
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        self.occluded_thr = occluded_thr
