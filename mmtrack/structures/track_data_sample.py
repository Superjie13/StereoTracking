...
class TrackDataSample(BaseDataElement):
    ...
    # Typically denotes the dense depth map of key frame

    @property
    def dense_depth_map(self):
        return self._dense_depth_map

    @dense_depth_map.setter
    def dense_depth_map(self, value):
        self.set_field(value, '_dense_depth_map')

    @dense_depth_map.deleter
    def dense_depth_map(self):
        del self._dense_depth_map
