...
class MOTDroneMetrics(BaseVideoMetric):
        ...
        for data_sample in data_samples:
            ...
            if 'instances' in data_sample:
                ...
                gt_tracks = [
                    ...
                    ]) for i in range(len(gt_instances)) if (self.ignore_depth or gt_instances[i]['location'][-1] <= self.depth_thr)
                ]
            ...
            pred_tracks = [
                ...
                ]) for i in range(len(pred_instances['instances_id'])) if
                ( self.ignore_depth or self.depth_thr >= pred_instances['depth'][i] > 0)
            ]
